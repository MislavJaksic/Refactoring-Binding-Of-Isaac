...
var levels=[
  {  
    ...
    level: function(){
      ...
      if (MoveForwardOnXAxisLevelOne()) {
        x_character += 5;
      };
      if (MoveBackOnXAxisLevelOne()) {
        x_character -= 5;
      };
      if (MoveBackOnYAxisLevelOne()) {
        y_character -= 5;
      };
      if (MoveForwardOnYAxisLevelOne()) {
        y_character += 5;
      };
...
function MoveForwardOnXAxisLevelOne(){
  if (d_pressed &&
...
function MoveBackOnXAxisLevelOne(){
  if (a_pressed &&
...
function MoveBackOnYAxisLevelOne(){
  if (w_pressed &&
...
function MoveForwardOnYAxisLevelOne(){
  if (s_pressed &&
...
function DrawHearts(){
  ...
  health_bar = new HealthBar(health_bar_start_point, heart_size, heart_spacing, health);
